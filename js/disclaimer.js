...
CP.disclaimer.HTML =
  ...
  '<p><strong>No warranty of accuracy.</strong> The App is provided “as is” and “as available.” RDanzen Ltd makes no representation ' +
  ...
  '<p><strong>Data handling.</strong> The App stores data locally on the user’s device. RDanzen Ltd is not responsible for loss, ' +
  'corruption, unauthorised access, or disclosure of data resulting from device loss, theft, failure, or user error.</p>' +
  '<p><strong>Limitation of liability.</strong> To the maximum extent permitted by law, RDanzen Ltd excludes all liability for any ' +
  ...
  '<p>RDanzen Ltd — ' + CP.disclaimer.VERSION_LABEL + '</p>';
