...
CP.disclaimer = (function () {
    ...
    var GLOBAL_KEY = 'disclaimerAcceptance';
                   ...
                   var HTML =
                         '<h3>Disclaimer</h3>' +
                         '<p>Close Protection Ops ("the App") is provided by RD Anzen Ltd as a planning and information-organisation aid for close protection and security professionals. It is not a substitute for professional judgement, risk assessment, or operational decision-making.</p>' +
                         '<p>By using the App, you acknowledge and agree that:</p>' +
                         '<ol>' +
                         '<li><strong>No warranty of accuracy.</strong> The App is provided "as is" and "as available." RD Anzen Ltd makes no representation or warranty, express or implied, as to the accuracy, completeness, reliability, or currency of any information entered, stored, generated, or displayed by the App, including but not limited to routes, venue data, contact details, medical information, or communications plans.</li>' +
                         ...
                         '<li><strong>Data handling.</strong> The App stores data locally on the user\'s device. RD Anzen Ltd is not responsible for loss, corruption, unauthorised access, or disclosure of data resulting from device loss, theft, failure, or user error.</li>' +
                         '<li><strong>Limitation of liability.</strong> To the maximum extent permitted by law, RD Anzen Ltd excludes all liability for any indirect, incidental, special, or consequential loss or damage -- including loss of data, loss of profit, or business interruption -- arising from use of, or inability to use, the App.</li>' +
                         ...
                         '<p><em>RD Anzen Ltd -- ' + VERSION_LABEL + '</em></p>';
...
CP.disclaimerGate = (function () {
                       ...
                       function render(html) {
                             document.body.insertAdjacentHTML('beforeend',
                                                                    '<div id="cpDisclaimerScreen"><div id="cpDisclaimerBox">' + html + '</div></div>');
                       }
      ...
      injectStyles();
                             render('<div id="cpDisclaimerScroll">' + CP.disclaimer.HTML + '</div>' +
